...
const GarisGradienPositif = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 200" width="280" height="200"
    ...
    <line x1="210" y1="57" x2="210" y2="152" stroke="#FACC15" strokeWidth="1.5" strokeDasharray="5,4" />
    {/* Horizontal dashed (sisi datar) */}
    <line x1="65" y1="152" x2="210" y2="152" stroke="#FACC15" strokeWidth="1.5" strokeDasharray="5,4" />
    {/* Right-angle square at corner (210,152) */}
    <polyline points="202,152 202,144 210,144" fill="none" stroke="#FACC15" strokeWidth="1.5" />
    {/* Label m = + */}
    <text x="218" y="29" fill="#FACC15" fontSize="13" fontFamily="sans-serif" fontWeight="bold">m = +</text>
    {/* Label Panjang sisi tegak */}
    <text x="216" y="112" fill="#FACC15" fontSize="11" fontFamily="sans-serif">Panjang sisi</text>
    <text x="216" y="126" fill="#FACC15" fontSize="11" fontFamily="sans-serif">tegak</text>
    {/* Label Panjang sisi datar */}
    <text x="108" y="168" fill="#FACC15" fontSize="11" fontFamily="sans-serif">Panjang sisi datar</text>
  </svg>
);
...
const GarisGradienNegatif = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 200" width="280" height="200"
    ...
    {/* Vertical dashed (sisi tegak) */}
    <line x1="70" y1="53" x2="70" y2="153" stroke="#FACC15" strokeWidth="1.5" strokeDasharray="5,4" />
    {/* Horizontal dashed (sisi datar) */}
    <line x1="70" y1="153" x2="210" y2="153" stroke="#FACC15" strokeWidth="1.5" strokeDasharray="5,4" />
    {/* Right-angle square at corner (70,153) */}
    <polyline points="78,153 78,145 70,145" fill="none" stroke="#FACC15" strokeWidth="1.5" />
    {/* Label m = - */}
    <text x="55" y="13" fill="#FACC15" fontSize="13" fontFamily="sans-serif" fontWeight="bold">m = -</text>
    {/* Label Panjang sisi tegak */}
    <text x="2" y="100" fill="#FACC15" fontSize="11" fontFamily="sans-serif">Panjang sisi</text>
    <text x="2" y="114" fill="#FACC15" fontSize="11" fontFamily="sans-serif">tegak</text>
    {/* Label Panjang sisi datar */}
    <text x="108" y="169" fill="#FACC15" fontSize="11" fontFamily="sans-serif">Panjang sisi datar</text>
  </svg>
);
