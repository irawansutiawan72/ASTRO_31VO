...
const subtopics = [
  ...
  { label: "SUDUT PELURUS, SUDUT PENYIKU DAN SUDUT BERTOLAK BELAKANG", path: "/coming-soon", soal: 40, icon: RotateCcw, gradient: "from-teal-900/40 to-emerald-900/30", border: "border-teal-500/30", badge: "bg-teal-500/20 text-teal-300 border-teal-400/40", iconBg: "bg-teal-500/20", iconColor: "text-teal-400", leftBar: "from-teal-400 to-emerald-500", desc: "Sudut berpelurus (180°), berpenyikut (90°), bertolak belakang, menghitung sudut" },
