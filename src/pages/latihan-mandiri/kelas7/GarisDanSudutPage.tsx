...
const subtopics = [
  ...
  { label: "SUDUT PELURUS, SUDUT PENYIKUT DAN SUDUT BERTOLAK BELAKANG", path: "/coming-soon", soal: 40, icon: RotateCcw, gradient: "from-teal-900/40 to-emerald-900/30", border: "border-teal-500/30", badge: "bg-teal-500/20 text-teal-300 border-teal-400/40", iconBg: "bg-teal-500/20", iconColor: "text-teal-400", leftBar: "from-teal-400 to-emerald-500", desc: "Sudut berpelurus (180°), berpenyikut (90°), bertolak belakang, menghitung sudut" },
  { label: "SIFAT SUDUT DUA GARIS SEJAJAR JIKA DIPOTONG GARIS LAIN", path: "/coming-soon", soal: 40, icon: AlignCenter, gradient: "from-emerald-900/40 to-green-900/30", border: "border-emerald-500/30", badge: "bg-emerald-500/20 text-emerald-300 border-emerald-400/40", iconBg: "bg-emerald-500/20", iconColor: "text-emerald-400", leftBar: "from-emerald-400 to-green-500", desc: "Sudut sehadap, berseberangan dalam/luar, sepihak dalam/luar pada dua garis sejajar" },
  { label: "JUMLAH SUDUT PADA SEGI BANYAK", path: "/coming-soon", soal: 40, icon: Pentagon, gradient: "from-green-900/40 to-lime-900/30", border: "border-green-500/30", badge: "bg-green-500/20 text-green-300 border-green-400/40", iconBg: "bg-green-500/20", iconColor: "text-green-400", leftBar: "from-green-400 to-lime-500", desc: "Rumus jumlah sudut segi-n: (n−2)×180°, sudut dalam dan luar poligon" },
];
