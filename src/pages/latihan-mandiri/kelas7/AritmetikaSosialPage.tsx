...
const subtopics = [
  { label: "JUAL BELI, UNTUNG DAN RUGI", path: "/latihan-mandiri/kelas-7/aritmetika-sosial/jual-beli-untung-rugi", soal: 40, icon: ShoppingCart, gradient: "from-yellow-900/40 to-amber-900/30", border: "border-yellow-500/30", badge: "bg-yellow-500/20 text-yellow-300 border-yellow-400/40", iconBg: "bg-yellow-500/20", iconColor: "text-yellow-400", leftBar: "from-yellow-400 to-amber-500", desc: "Harga beli, harga jual, persentase untung/rugi, soal cerita perdagangan" },
  { label: "DISKON", path: "/latihan-mandiri/kelas-7/aritmetika-sosial/diskon", soal: 40, icon: Tag, gradient: "from-orange-900/40 to-red-900/30", border: "border-orange-500/30", badge: "bg-orange-500/20 text-orange-300 border-orange-400/40", iconBg: "bg-orange-500/20", iconColor: "text-orange-400", leftBar: "from-orange-400 to-red-500", desc: "Pengertian diskon, harga setelah diskon, diskon bertingkat, soal belanja" },
  { label: "BRUTO, NETTO DAN TARA", path: "/latihan-mandiri/kelas-7/aritmetika-sosial/bruto-netto-tara", soal: 40, icon: Package, gradient: "from-amber-900/40 to-yellow-900/30", border: "border-amber-500/30", badge: "bg-amber-500/20 text-amber-300 border-amber-400/40", iconBg: "bg-amber-500/20", iconColor: "text-amber-400", leftBar: "from-amber-400 to-yellow-500", desc: "Hubungan bruto = netto + tara, persentase tara, soal kemasan produk" },
  { label: "BUNGA TUNGGAL", path: "/latihan-mandiri/kelas-7/aritmetika-sosial/bunga-tunggal", soal: 40, icon: TrendingUp, gradient: "from-lime-900/40 to-green-900/30", border: "border-lime-500/30", badge: "bg-lime-500/20 text-lime-300 border-lime-400/40", iconBg: "bg-lime-500/20", iconColor: "text-lime-400", leftBar: "from-lime-400 to-green-500", desc: "Rumus bunga tunggal, menghitung bunga tabungan & pinjaman, soal bank" },
  { label: "PAJAK PERTAMBAHAN NILAI (PPN)", path: "/latihan-mandiri/kelas-7/aritmetika-sosial/ppn", soal: 40, icon: Receipt, gradient: "from-emerald-900/40 to-teal-900/30", border: "border-emerald-500/30", badge: "bg-emerald-500/20 text-emerald-300 border-emerald-400/40", iconBg: "bg-emerald-500/20", iconColor: "text-emerald-400", leftBar: "from-emerald-400 to-teal-500", desc: "Pengertian PPN, menghitung nilai PPN 10%, harga sebelum & sesudah PPN" },
  { label: "PAJAK PENGHASILAN (PPH)", path: "/latihan-mandiri/kelas-7/aritmetika-sosial/pph", soal: 40, icon: Banknote, gradient: "from-teal-900/40 to-cyan-900/30", border: "border-teal-500/30", badge: "bg-teal-500/20 text-teal-300 border-teal-400/40", iconBg: "bg-teal-500/20", iconColor: "text-teal-400", leftBar: "from-teal-400 to-cyan-500", desc: "Pengertian PPh, menghitung pajak penghasilan, penghasilan kena pajak" },
];
