...
const subtopics = [
  { label: "GARIS BERAT, GARIS BAGI DAN GARIS TINGGI PADA SEGITIGA", path: "/latihan-mandiri/kelas-7/segitiga-dan-segiempat/garis-berat-bagi-tinggi", soal: 40, icon: Triangle, gradient: "from-rose-900/40 to-pink-900/30", border: "border-rose-500/30", badge: "bg-rose-500/20 text-rose-300 border-rose-400/40", iconBg: "bg-rose-500/20", iconColor: "text-rose-400", leftBar: "from-rose-400 to-pink-500", desc: "Garis berat (median), garis bagi, garis tinggi, titik berat, dan titik ortosenter" },
  { label: "KELILING SEGITIGA DAN SEGIEMPAT", path: "/latihan-mandiri/kelas-7/segitiga-dan-segiempat/keliling-segitiga-dan-segiempat", soal: 40, icon: RectangleHorizontal, gradient: "from-pink-900/40 to-fuchsia-900/30", border: "border-pink-500/30", badge: "bg-pink-500/20 text-pink-300 border-pink-400/40", iconBg: "bg-pink-500/20", iconColor: "text-pink-400", leftBar: "from-pink-400 to-fuchsia-500", desc: "Keliling segitiga, persegi, persegi panjang, jajar genjang, belah ketupat, trapesium" },
  { label: "LUAS SEGITIGA", path: "/latihan-mandiri/kelas-7/segitiga-dan-segiempat/luas-segitiga", soal: 40, icon: Maximize2, gradient: "from-fuchsia-900/40 to-violet-900/30", border: "border-fuchsia-500/30", badge: "bg-fuchsia-500/20 text-fuchsia-300 border-fuchsia-400/40", iconBg: "bg-fuchsia-500/20", iconColor: "text-fuchsia-400", leftBar: "from-fuchsia-400 to-violet-500", desc: "Rumus L = ½×a×t, berbagai jenis segitiga, soal kontekstual luas segitiga" },
  { label: "LUAS SEGIEMPAT", path: "/latihan-mandiri/kelas-7/segitiga-dan-segiempat/luas-segiempat", soal: 40, icon: Square, gradient: "from-violet-900/40 to-indigo-900/30", border: "border-violet-500/30", badge: "bg-violet-500/20 text-violet-300 border-violet-400/40", iconBg: "bg-violet-500/20", iconColor: "text-violet-400", leftBar: "from-violet-400 to-indigo-500", desc: "Luas persegi, persegi panjang, jajar genjang, trapesium, belah ketupat, layang-layang" },
  { label: "KELILING DAN LUAS BANGUN TAK BERATURAN", path: "/latihan-mandiri/kelas-7/segitiga-dan-segiempat/keliling-luas-bangun-tak-beraturan", soal: 40, icon: Shapes, gradient: "from-indigo-900/40 to-blue-900/30", border: "border-indigo-500/30", badge: "bg-indigo-500/20 text-indigo-300 border-indigo-400/40", iconBg: "bg-indigo-500/20", iconColor: "text-indigo-400", leftBar: "from-indigo-400 to-blue-500", desc: "Menghitung keliling & luas bangun gabungan, metode dekomposisi, soal denah" },
];
