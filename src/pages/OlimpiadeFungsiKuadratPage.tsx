...
const latihanDasar: { no: number; soal: string; options: string[]; svgOptions?: ReactNode[] }[] = [
  ...
  { no: 6, soal: "Kurva yang mempunyai sumbu simetri di $x = 1$ adalah ...", options: ["A.", "B.", "C.", "D."], svgOptions: [<img src="/no_6_opsi_A.png" alt="Opsi A" className="mt-1 block max-w-[165px] w-full" />, miniParabola(-3, 2, true), <img src="/no_6_opsi_C.png" alt="Opsi C" className="mt-1 block max-w-[165px] w-full" />, <img src="/no_6_opsi_D.png" alt="Opsi D" className="mt-1 block max-w-[165px] w-full" />] },
